...
@Component({
  selector: 'app-desktop-table-work-permit-employee',
  standalone: true,
  imports: [SharedModule, MatIconModule, NgSelectModule],
  templateUrl: './desktop-table-work-permit-employee.component.html',
  styleUrl: './desktop-table-work-permit-employee.component.scss',
})
export class DesktopTableWorkPermitEmployeeComponent {
