...
@Component({
  selector: 'app-desktop-approval-table-leave',
  standalone: true,
  imports: [SharedModule, MatIconModule, NgSelectModule],
  templateUrl: './desktop-approval-table-leave.component.html',
  styleUrl: './desktop-approval-table-leave.component.scss'
})
export class DesktopApprovalTableLeaveComponent {
